...
ns.setHistory = { history=true, name="Lunar Festival", noCoords=true, noContinent=true, alwaysShow=true,
...
ns.setMetaFaction = { metaFaction=true, noCoords=true, noContinent=true, alwaysShow=true, 
...
ns.setPyro = { coins=true, noCoords=true, noContinent=true, alwaysShow=true, 
				achievements={ { id=1552, showAllCriteria=true, }, { id=1281, showAllCriteria=true, }, }, }
if ( ns.version < 60000 ) then
	ns.setElune = { elune=true, noCoords=true, noContinent=true, alwaysShow=true, achievements={ { id=937, }, },
				quests={ { id=8868, name="Elune's Blessing", qType="Seasonal", }, }, }
	ns.setNewZones = { newZones=true, noCoords=true, noContinent=true, alwaysShow=true, achievements={ { id=626, }, }, }
else
	ns.setElune = { elune=true, noCoords=true, noContinent=true, alwaysShow=true, achievements={ { id=937, }, { id=626, }, },
				quests={ { id=8868, name="Elune's Blessing", qType="Seasonal", }, }, }
	ns.setNewZones = { newZones=true, noCoords=true, noContinent=true, alwaysShow=true, guide=ns.metaGuide,
...
ns.points[ ns.map.kalimdor ] = { -- Kalimdor
	...
	[05002100] = ns.setHistory,
	[05201700] = ns.setMetaFaction,
	[07302400] = ns.setPyro,
	[07401980] = ns.set50Coins,
}
