...
VUHDO_BOUQUET_LAYER_TYPE_NONSECRET = 1;
VUHDO_BOUQUET_LAYER_TYPE_CURVE = 2;
VUHDO_BOUQUET_LAYER_TYPE_DISPEL = 3;
VUHDO_BOUQUET_LAYER_TYPE_AURA = 4;
VUHDO_BOUQUET_LAYER_TYPE_SPRITECELL = 5;

VUHDO_UNIT_AURA_SOURCE_MINE = 1;
VUHDO_UNIT_AURA_SOURCE_OTHERS = 2;
VUHDO_UNIT_AURA_SOURCE_BOTH = 3;
...
VUHDO_SPELL_DURATION_MODE_THRESHOLD = 0;
VUHDO_SPELL_DURATION_MODE_FULL = 1;
VUHDO_SPELL_DURATION_MODE_ALIVE = 2;
