...
-- Big new chunk from AllTheThings.lua
	...
	L.PLEASE_REPORT_MESSAGE = ": Bitte melden Sie den Fehler an die ATT Discord in #retail-errors! Danke!";
	L.REPORT_TIP = "\n("..CTRL_KEY_TEXT.."+C um mehrere Lienen zu kopieren.)";
	L.NOT_AVAILABLE_IN_PL = "Nicht vorhanden in Personal Loot.";
	...
	L.FACTION_SPECIFIC_REP = "Nicht alle Rufe können mit einem Charakter angesehn werden. z.B. Kriegshymnenklans können nicht mit einem Allianz Charakter angesehn werden, und Silberschwingen können nicht mit einem Horde Charakter angesehn werden.";
	...
	L.SELFIE_DESC = "Nehmen Sie einen selfie mit Ihrem ";
	...
	L.SL_TIER_DESC = "Shadowlands ist die achte Erweiterung. Was liegt hinter die Welt die du kennst? Die Shadowlands, Ruheplatz für jede sterbliche seele—tugendhaft oder abscheulich—die jemals gelebt hat.";
	...
	L.TSM_WARNING_2 = " Voreinstellung.\n\nWir empfehlen das Sie ein anderes Profil benuzten für diese Funktion.\n\nMöchten Sie trotzdem fortfahren?";
	L.PRESET_UPDATE_SUCCESS = "Die Voreinstellung wurde erfolgreich aktualisiert.";
	L.SHOPPING_OP_MISSING_1 = "Der Voreinstellung fehlt eine 'Shopping' Funktion zuweisung.";
	...
	L.DURING_WQ_ONLY = "Dies kann abgeschlossen werden, solange die Weltquest aktiv ist.";
	...
	L.DISABLE_PARTYSYNC = "Dies ist vermutlich nicht abschließbar, selbst mit aktiver Partysynchronisation. Sollte es doch abschließbar sein, melde Dich im Discord!";
