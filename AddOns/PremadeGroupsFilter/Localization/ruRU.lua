...
L["dialog.dungeon.alert.single.info"] = "При поиске одного подземелья Вы получите гораздо более релевантные результаты, если введете часть названия подземелья в стандартное поле поиска, например, «neltharus» или «vortex 10». Из-за ограничений аддоны не могут изменить поле поиска за Вас."
