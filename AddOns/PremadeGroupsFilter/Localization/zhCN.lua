...
L["dialog.tooltip.partyfit"] = "团队中我的角色有一席之地"
...
L["settings.classNamesInTooltip.tooltip"] = "在预制组的工具提示中按角色显示分类列表。"
...
L["settings.classBar.tooltip"] = "在预制建队伍列表内的每个玩家角色下方显示一个职业颜色栏"
L["settings.classCircle.title"] = "职业颜色圆圈"
L["settings.classCircle.tooltip"] = "在预制建队伍列表内每个玩家角色背景上显示一个职业颜色圆圈"
L["settings.leaderCrown.title"] = "显示队长标记"
L["settings.leaderCrown.tooltip"] = "在预制组列表中队长角色上方显示一个小皇冠。"
L["settings.ratingInfo.title"] = "队长评分"
L["settings.ratingInfo.tooltip"] = "在预制组列表中显示队长的钥石或PvP评级评分"
