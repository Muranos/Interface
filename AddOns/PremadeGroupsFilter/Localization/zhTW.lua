...
L["message.noplaystylefix"] = "預創建隊伍過濾: 不會修復“接口操作因AddOn而失敗”錯誤，因為您似乎沒有完全安全的帳戶，否則無法創建預製隊伍。請參閱插件常見問題解答以獲取更多信息以及如何解決此問題。"
...
L["dialog.tooltip.partyfit"] = "團隊中我的角色有一席之地"
...
L["settings.classNamesInTooltip.title"] = "工具提示中的分類"
L["settings.classNamesInTooltip.tooltip"] = "在預製組的工具提示中按角色顯示分類列表。"
L["settings.coloredGroupTexts.title"] = "彩色隊伍名稱和活動"
L["settings.coloredGroupTexts.tooltip"] = "如果隊伍是新的，則以綠色顯示隊伍名稱，如果您之前被拒絕，則以紅色顯示。如果您對該隊伍進行了鎖定，則以紅色顯示活動名稱。"
L["settings.classBar.title"] = "職業顏色欄"
L["settings.classBar.tooltip"] = "在預製建隊伍列表內的每個玩家角色下方顯示一個職業顏色欄"
L["settings.classCircle.title"] = "職業顏色圓圈"
L["settings.classCircle.tooltip"] = "在預製建隊伍列表內每個玩家角色背景上顯示一個職業顏色圓圈"
L["settings.leaderCrown.title"] = "顯示隊長標記"
L["settings.leaderCrown.tooltip"] = "在預製組列表中隊長角色上方顯示一個小皇冠。"
L["settings.ratingInfo.title"] = "隊長評分"
L["settings.ratingInfo.tooltip"] = "在預製組列表中顯示隊長的鑰石或PvP評級評分"
